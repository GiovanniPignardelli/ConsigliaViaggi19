...
public class Hotel extends Place {
    ...
    public Hotel(String name, String address, String city, String postal_code, String state, String priceTag, List<String> tags, String addYear, String latitude, String longitude, String email, String telephone, String website, List<String> roomTags, List<String> roomTypeTags, Integer hClass) {
